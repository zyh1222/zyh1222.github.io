...
function to_context_tree(keyword, select) {
    ...
    function context_tree(keyword, select) {
        ...
        var timeticks = ['2013-01-04', '2013-07-23', '2014-02-08', '2014-08-27', '2015-03-15', '2015-10-01']
...
// append the svg object to the body of the page
    ...
    var x = d3.scaleTime()
        .domain([new Date("2013-01-04 00:00"), new Date("2015-12-05 00:00")])
        .range([0, width]);

    var xb = d3.scaleTime()
        .domain([0, width])
        .range([new Date("2013-01-04 00:00"), new Date("2015-12-05 00:00")]);
    ...
    function brushended() {
        ...
        const time_index = {'40': 8, '190': 9, '30': 12, '180': 13, '50': 71, '200': 70, '20': 14, '170': 15, '10': 18, '160': 19, '310': 20, '150': 29, '300': 30, '140': 33, '290': 34, '130': 37, '280': 38, '120': 39, '270': 40, '110': 43, '260': 44, '100': 53, '250': 54, '90': 57, '240': 58, '80': 61, '230': 62, '70': 63, '220': 64, '60': 67, '210': 68}
...
svg.append('image').attr("xlink:href", "xinhua.png")
    .attr('x', 590)
    .attr('width', 40)
    .attr('height', 40)
    .on('click',function(d){
...
svg.append('rect')
    ...
    .attr('stroke', '#fc9b9a')
    .attr('fill', '#fc9b9a');
svg.append('image').attr("xlink:href", "newyork.png")
    .attr('x', 590)
    .attr('width', 50)
    .attr('height', 40)
    .on('click', function (d) {
