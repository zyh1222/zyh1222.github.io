...
// append the svg object to the body of the page
    ...
    var x = d3.scaleTime()
        .domain([new Date("2021-02-21 00:00"), new Date("2021-02-24 00:00")])
        .range([0, width]);

    var xb = d3.scaleTime()
        .domain([0, width])
        .range([new Date("2020-02-21 00:00"), new Date("2020-02-24 00:00")]);
...
svg.append('image').attr("xlink:href", "zuguo.png")
    .attr('x', 590)
    .attr('width', 40)
    .attr('height', 40)
    .on('click',function(d){
...
svg.append('rect')
    ...
    .attr('stroke', '#fc9b9a')
    .attr('fill', '#fc9b9a');
svg.append('image').attr("xlink:href", "辣笔.png")
    .attr('x', 590)
    .attr('width', 50)
    .attr('height', 40)
    .on('click', function (d) {
